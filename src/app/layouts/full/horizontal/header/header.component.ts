...
export class AppHorizontalHeaderComponent {
    ...
    fetchNotifications(): void {
        ...
        console.log(userId);
        this.http
            .get(`https://cultivua-laravel-production.up.railway.app/api/notifications/${userId}`)
    ...
    handleNotificationClick(notification: any): void {
        if (notification.is_read === 0) {
            ...
            this.http
                .put(
                    `https://cultivua-laravel-production.up.railway.app/api/notifications/${notification.id}/mark-read`,
                    {}
                )
                .subscribe({
                    error: (err) => {
