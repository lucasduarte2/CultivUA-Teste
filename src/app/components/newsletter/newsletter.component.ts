...
import { UserService } from "../../services/user.service"; // Serviço que lida com a atualização do usuário
    ...
    ngOnInit() {
        ...
        this.authService.isAuthenticated$.subscribe((isAuthenticated) => {
            if (isAuthenticated) {
                ...
                if (userId) {
                    // Carregar o estado de subscrição quando o usuário estiver autenticado
