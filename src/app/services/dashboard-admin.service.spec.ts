...
describe('AdminDashboardService', () => {
    ...
    it('should fetch dashboard stats', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/dashboard-stats`);
    ...
    it('should fetch products sold by category', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/products-sold-by-category`);
        expect(req.request.method).toBe('GET');
        req.flush(dummyData);
    });
    ...
    it('should fetch monthly sales with parameters', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/monthly-sales?month=1&year=2023`);
        expect(req.request.method).toBe('GET');
    ...
    it('should fetch monthly sales without parameters', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/monthly-sales`);
        expect(req.request.method).toBe('GET');
        req.flush(dummySales);
    });
    ...
    it('should fetch plant data by day', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/plant-data-by-day`);
        expect(req.request.method).toBe('GET');
        req.flush(dummyData);
    });
});