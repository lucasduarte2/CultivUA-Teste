...
describe('PlantInformacaoService', () => {
  ...
  it('should fetch plant data by ID', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/plant-informacao/1');
  ...
  it('should update plant image', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/users_plants/${userPlantId}/update-image`);
  ...
  it('should fetch plant data by userPlantId', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/planta-info/1');
    expect(req.request.method).toBe('GET');
