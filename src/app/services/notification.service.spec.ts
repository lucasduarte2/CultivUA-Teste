...
describe('NotificationService', () => {
  ...
  it('should retrieve user notifications from the API via GET', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/notifications`);
  ...
  it('should retrieve admin notifications from the API via GET', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/notifications/admin`);
    expect(req.request.method).toBe('GET');
    expect(req.request.headers.get('Authorization')).toBe('Bearer fakeAuthToken');
    req.flush(dummyNotifications);
  });
  ...
  it('should mark a notification as read via PUT', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/notifications/${notificationId}/mark-read`);
