...
export class LocationService {
    private baseUrl = `https://cultivua-laravel-production.up.railway.app/api/locations`;
    private apiUrl = "https://cultivua-laravel-production.up.railway.app/api/kit-readings";

    constructor(private http: HttpClient) {}

    // Método para buscar todas as locations
