...
export class DashboardPlantService {
    private apiUrl = "https://cultivua-laravel-production.up.railway.app/api/"; // URL do Laravel

    constructor(private http: HttpClient) { }
    // Método para buscar plantas do usuário
    ...
    /**
     * Retorna as plantas de um usuário específico
    ...
    /**
     * Retorna as plantas do usuário com os kits associados
     * @param userId ID do usuário
     */
   ...
   */
    ...
    /**
     * Busca os detalhes de uma planta e do kit associado
