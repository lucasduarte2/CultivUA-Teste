...
describe('PlantService', () => {
  ...
  it('should search for plants', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/plants/search`);
  ...
  it('should add plant to dashboard', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/user-plants/add`);
    expect(req.request.method).toBe('POST');
  ...
  it('should identify plant', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/identify-plant`);
    expect(req.request.method).toBe('POST');
    req.flush(dummyResponse);
  });
  ...
  it('should save plant', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/plants/1`);
