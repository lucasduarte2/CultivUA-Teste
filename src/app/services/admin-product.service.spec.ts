...
describe('ServiceProductAdmin', () => {
    ...
    it('should fetch a product by id', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/products/1`);
    ...
    it('should update a product', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/updateProduct/1`);
    ...
    it('should fetch categories', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/categories`);
        expect(req.request.method).toBe('GET');
    ...
    it('should fetch a product for update by id', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/getproductUp/1`);
        expect(req.request.method).toBe('GET');
        req.flush(dummyProduct);
    });
});