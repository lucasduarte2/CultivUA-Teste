...
describe('AuthService', () => {
  ...
  it('should login and set token', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/login`);
  ...
  it('should logout and clear token', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/logout`);
    expect(req.request.method).toBe('POST');
    req.flush({});
  });
  ...
  it('should register a new user', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/register`);
    expect(req.request.method).toBe('POST');
    req.flush(mockResponse);
  });
  ...
  it('should get user details', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/user`);
  ...
  it('should login admin and set token', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/admin/login`);
    expect(req.request.method).toBe('POST');
    req.flush(mockResponse);
  });
  ...
  it('should logout admin and clear token', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/admin/logout`);
    expect(req.request.method).toBe('POST');
    req.flush({});
  });
});
