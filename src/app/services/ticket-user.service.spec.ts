...
describe('TicketUserService', () => {
    ...
    it('should create a ticket', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/ticket-user`);
    ...
    it('should get user tickets', () => {
        ...
        const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/tickets`);
