...
describe('UserService', () => {
  ...
  it('should update newsletter subscription', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/users/1/newsletter`);
  ...
  it('should get user details header', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/userdetails/${userId}`);
    expect(req.request.method).toBe('GET');
