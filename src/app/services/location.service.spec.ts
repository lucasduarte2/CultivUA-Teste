...
describe('LocationService', () => {
  ...
  it('should delete a location', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/locations/${locationId}`);
  ...
  it('should fetch a location by id', () => {
    ...
    const req = httpMock.expectOne(`https://cultivua-laravel-production.up.railway.app/api/locations/1`);
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch kit readings', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/kit-readings/kit1');
    expect(req.request.method).toBe('GET');
