...
export class UsersPlantsService {
  private apiUrl = "https://cultivua-laravel-production.up.railway.app/api/users-plants"; // Substitua com a URL real da sua API

  constructor(private http: HttpClient) { }

  /**
   * Obtém todas as plantas de um usuário com base no seu ID
