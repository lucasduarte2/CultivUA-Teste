...
describe('DashboardPlantService', () => {
  ...
  it('should fetch user plants table', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/userplants/1');
  ...
  it('should fetch locations by user plant id', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/location/1');
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch all plants', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/plants');
    expect(req.request.method).toBe('GET');
    req.flush(dummyPlants);
  });
  ...
  it('should fetch user plants', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/user-plants/1');
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch user plants with kits', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/user-plants-kits/1');
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch kit by id', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/kits/1');
    expect(req.request.method).toBe('GET');
    req.flush(dummyKit);
  });
  ...
  it('should fetch all locations', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/locations');
    expect(req.request.method).toBe('GET');
    req.flush(dummyLocations);
  });
  ...
  it('should associate kit to user plant', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/plants/1/associate-kit');
  ...
  it('should fetch plant details', () => {
    ...
    const req = httpMock.expectOne('https://cultivua-laravel-production.up.railway.app/api/plants/1/details');
    expect(req.request.method).toBe('GET');
