...
import pt from '@angular/common/locales/pt';  // Importando a localidade pt-PT
...
export class DashboardAdminComponent {
  ...
  generatePDF(): void {
    ...
    // Usando html2canvas para capturar o conteúdo
    html2canvas(content).then((canvas: HTMLCanvasElement) => {
      const imgData = canvas.toDataURL('image/png');

      // Criando uma instância do jsPDF para formato A5
      const pdf = new jsPDF({
